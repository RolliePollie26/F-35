// F35ACockpit.cpp : Defines the exported functions for the DLL application.
//

#include "stdafx.h"
#include <windows.h>

#include "F35Cockpit.h"
...
bool locateEfmDll()
{
	...
	HMODULE	efm_dll = GetModuleHandle(L"F35A.dll"); //assume that we work inside same process
	if (efm_dll == NULL)
	{
		return false;
	}
