...
#ifndef _F35ACOCKPIT_H_
#define _F35ACOCKPIT_H_

#include "ED_Cockpit_Defs.h"
//#include "include/ccParametersAPI.h"
...
COCKPITBASE_API double test(double in);

#endif _F35ACOCKPIT_H_
