...
#ifndef _F35ENGINE_H_
#define _F35ENGINE_H_
...
public:
	...
	F35EngineParameters(EngineType engine)
		: engineType(engine)
		, angular_momentum(216.9)
		, maxDiameter(46.5 * F35::inchesToCentim) // in -> cm
		, inletDiameter(34.8 * F35::inchesToCentim) // in -> cm
		, bypassRatio(0)
		, minCompress(0)
		, maxCompress(0)
...
public:
	...
	F35EngineParameters engineParams;
	...
	F35Engine(EngineType engine, F35Atmosphere *atmos)
		: m_power3(0)
		, m_thrust_N(0)
		, m_percentPower(0)
		, afterburnerDraw(0)
	...
	*/
	...
	void updateOldStuff(double frameTime)
	{
		...
		double altFeet = pAtmos->altitude * F35::meterToFoot;
