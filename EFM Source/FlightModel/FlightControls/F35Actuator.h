#ifndef _F35ACTUATOR_H_
#define _F35ACTUATOR_H_
...
public:
	...
	F35Actuator(const double moverate)
	...
	{}
	F35Actuator(const double moverate, const double minLimit, const double maxLimit)
		: m_moveRate(moverate), m_commanded(0), m_current(0),
