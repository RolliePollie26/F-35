#ifndef _F35FCSCOMMON_H_
#define _F35FCSCOMMON_H_
...
public:
	F35TrimState(const double pitch, const double roll, const double yaw)
...
public:
	...
	{
		return rollRate_RPS * F35::radiansToDegrees;
	}
	double getPitchRateDegs() const
	{
		return pitchRate_RPS * F35::radiansToDegrees;
	}
	double getYawRateDegs() const
	{
		return yawRate_RPS * F35::radiansToDegrees;
	}

	double getAccZPerG() const
	{
		return accz / F35::standard_gravity;
	}
	double getAccYPerG() const
	{
		return accy / F35::standard_gravity;
	}
};

// keep flight surface positions in one place
class F35FlightSurface
{
public:
