#ifndef _F35AIRFRAME_H_
#define _F35AIRFRAME_H_
...
// (0=off, 1=on)
class F35LightBlinker
{
private:
	// disallow direct copying
	F35LightBlinker(const F35LightBlinker &other);
	F35LightBlinker& operator=(const F35LightBlinker &other);
...
public:
	...
	F35LightBlinker(const int seqCount, const double blinker) 
...
protected:
	...
	F35Actuator actCanopy;
	F35Actuator actRefuelingDoor; // trapdoor in the back
	...
	F35LightBlinker leftBlinker;
	F35LightBlinker rightBlinker;
	F35LightBlinker backBlinker;
